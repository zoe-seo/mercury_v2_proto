...
│         │                                             │
│  Spec   │  ┌──────────────────────────────────────┐   │
│  Panel  │  │ Toolbar (Floating, 상단 중앙)         │   │
│ (320px) │  │ [Select][Brush][Shape] | [Undo][Redo]│   │
│         │  └──────────────────────────────────────┘   │
│         │                                             │
│         │ ┌──┐                                 ┌────┐ │
│         │ │T │         Infinite Canvas         │ L  │ │
...
- Side Nav: **Spec Panel (왼쪽)** 사용

#### Spec Side Panel (Left, 320px, Collapsible)
- **위치**: 왼쪽 사이드바 고정
- **너비**: 기본 320px, 접을 시 0px (완전 숨김)
- **내용**: Design Brief (Global Context)
- **토글**: Header의 왼쪽 햄버거 메뉴 또는 패널 가장자리의 핸들로 토글
