...
import { Wand2, X, Sparkles, Paintbrush, Loader2, RefreshCw } from 'lucide-react';
...
export const AIPromptPanel = ({ position, onClose, isOpen = true, onCreatePackage }: AIPromptPanelProps) => {
    ...
    >
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 relative">
          <textarea 
            placeholder={inpaintMode ? "Describe what to fill in..." : "Describe what to generate..."}
            value={prompt}
      ...
      <div className="flex items-center justify-between border-t border-gray-100 pt-2">
         <div className="flex gap-1">
            ...
            >
             ...
             <button className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-medium text-gray-500 hover:bg-gray-50 transition-colors">
                 <RefreshCw size={14} />
                 Variations
             </button>
         </div>
